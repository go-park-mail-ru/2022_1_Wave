...
func (c *albumUseCaseClient) Like(ctx context.Context, in *gatewayProto.UserIdAlbumIdArg, opts ...grpc.CallOption) (*empty.Empty, error) {
	out := new(empty.Empty)
	err := c.cc.Invoke(ctx, "/album.AlbumUseCase/Like", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *albumUseCaseClient) LikeCheckByUser(ctx context.Context, in *gatewayProto.UserIdAlbumIdArg, opts ...grpc.CallOption) (*gatewayProto.LikeCheckResponse, error) {
	out := new(gatewayProto.LikeCheckResponse)
	err := c.cc.Invoke(ctx, "/album.AlbumUseCase/LikeCheckByUser", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *albumUseCaseClient) GetPopularAlbumOfWeekTop20(ctx context.Context, in *empty.Empty, opts ...grpc.CallOption) (*AlbumsResponse, error) {
	out := new(AlbumsResponse)
	err := c.cc.Invoke(ctx, "/album.AlbumUseCase/GetPopularAlbumOfWeekTop20", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedAlbumUseCaseServer) Like(context.Context, *gatewayProto.UserIdAlbumIdArg) (*empty.Empty, error) {
	return nil, status.Errorf(codes.Unimplemented, "method Like not implemented")
}
func (UnimplementedAlbumUseCaseServer) LikeCheckByUser(context.Context, *gatewayProto.UserIdAlbumIdArg) (*gatewayProto.LikeCheckResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method LikeCheckByUser not implemented")
}
func (UnimplementedAlbumUseCaseServer) GetPopularAlbumOfWeekTop20(context.Context, *empty.Empty) (*AlbumsResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetPopularAlbumOfWeekTop20 not implemented")
}
...
func _AlbumUseCase_Like_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(gatewayProto.UserIdAlbumIdArg)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(AlbumUseCaseServer).Like(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/album.AlbumUseCase/Like",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AlbumUseCaseServer).Like(ctx, req.(*gatewayProto.UserIdAlbumIdArg))
	}
	return interceptor(ctx, in, info, handler)
}

func _AlbumUseCase_LikeCheckByUser_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(gatewayProto.UserIdAlbumIdArg)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(AlbumUseCaseServer).LikeCheckByUser(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/album.AlbumUseCase/LikeCheckByUser",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AlbumUseCaseServer).LikeCheckByUser(ctx, req.(*gatewayProto.UserIdAlbumIdArg))
	}
	return interceptor(ctx, in, info, handler)
}

func _AlbumUseCase_GetPopularAlbumOfWeekTop20_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(empty.Empty)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(AlbumUseCaseServer).GetPopularAlbumOfWeekTop20(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/album.AlbumUseCase/GetPopularAlbumOfWeekTop20",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AlbumUseCaseServer).GetPopularAlbumOfWeekTop20(ctx, req.(*empty.Empty))
	}
	return interceptor(ctx, in, info, handler)
}
