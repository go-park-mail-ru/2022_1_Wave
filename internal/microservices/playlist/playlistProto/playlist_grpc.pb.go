...
type PlaylistUseCaseClient interface {
	GetAll(ctx context.Context, in *gatewayProto.IdArg, opts ...grpc.CallOption) (*PlaylistsResponse, error)
	GetLastId(ctx context.Context, in *gatewayProto.IdArg, opts ...grpc.CallOption) (*gatewayProto.IntResponse, error)
...
func (c *playlistUseCaseClient) GetAll(ctx context.Context, in *gatewayProto.IdArg, opts ...grpc.CallOption) (*PlaylistsResponse, error) {
...
func (c *playlistUseCaseClient) GetLastId(ctx context.Context, in *gatewayProto.IdArg, opts ...grpc.CallOption) (*gatewayProto.IntResponse, error) {
...
func (c *playlistUseCaseClient) GetSize(ctx context.Context, in *gatewayProto.IdArg, opts ...grpc.CallOption) (*gatewayProto.IntResponse, error) {
	out := new(gatewayProto.IntResponse)
...
type PlaylistUseCaseServer interface {
	GetAll(context.Context, *gatewayProto.IdArg) (*PlaylistsResponse, error)
	GetLastId(context.Context, *gatewayProto.IdArg) (*gatewayProto.IntResponse, error)
...
func (UnimplementedPlaylistUseCaseServer) GetAll(context.Context, *gatewayProto.IdArg) (*PlaylistsResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetAll not implemented")
}
func (UnimplementedPlaylistUseCaseServer) GetLastId(context.Context, *gatewayProto.IdArg) (*gatewayProto.IntResponse, error) {
...
func _PlaylistUseCase_GetAll_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(PlaylistUseCaseServer).GetAll(ctx, req.(*gatewayProto.IdArg))
	}
...
func _PlaylistUseCase_GetLastId_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(PlaylistUseCaseServer).GetLastId(ctx, req.(*gatewayProto.IdArg))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _PlaylistUseCase_GetById_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(PlaylistUseCaseServer).GetById(ctx, req.(*UserIdPlaylistIdArg))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _PlaylistUseCase_GetSize_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(PlaylistUseCaseServer).GetSize(ctx, req.(*gatewayProto.IdArg))
	}
	return interceptor(ctx, in, info, handler)
}
