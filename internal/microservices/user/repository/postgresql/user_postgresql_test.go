...
func TestInsertSuccess(t *testing.T) {
	...
	user := &user_microservice_domain.User{
		ID:             1,
		Username:       "aboba",
...
func TestUpdateSuccess(t *testing.T) {
	...
	userToUpdate1 := &user_microservice_domain.User{
		ID:       3,
		Username: "abobus",
		Email:    "",
		Password: "",
	...
	userToUpdate2 := &user_microservice_domain.User{
		ID:       4,
		Username: "",
		Email:    "aboba@aboba.ru",
		Password: "aboba",
...
func TestUpdateError(t *testing.T) {
	...
	userToUpdate := &user_microservice_domain.User{
		ID:       4,
		Username: "",
		Email:    "aboba@aboba.ru",
		Password: "aboba",
